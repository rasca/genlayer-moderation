...
export const metadata: Metadata = {
  title: "GenLayer Content Moderation",
  description: "AI-powered content moderation on GenLayer blockchain. Create guidelines and moderate content with decentralized AI.",
